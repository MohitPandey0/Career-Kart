    ...
    <div className="container">
      <div className="row gy-3 align-items-center section-title mb-0">
        <div className="col-sm-6">
          <h1 className="h3 mb-0 title">All Tags</h1>
        </div>
      ...
      <div className="row">
        <div className="col-xl-9 col-lg-10 mx-auto">
          <div className="mb-5 lead">
            ...
            <div className="nav d-flex d-sm-inline-flex" id="filterTaxonomy">
              <button className="bg-transparent outline-0 border-0 p-0 me-4 text-dark fw-normal nav-link active">
                Alphabetically
              </button>
              <button className="bg-transparent outline-0 border-0 p-0 text-dark fw-normal nav-link ">
                Popularity
              </button>
            </div>
          </div>
          <div className="row g-2 taxonomy-lists">
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  AI<small className="ms-1">(1)</small>
                </div>
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Art<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Business<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Culture<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Earth<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Fitness<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Futurism<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Health<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Innovation<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Job<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Lifestyle<small className="ms-1">(2)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              <a
                className="text-dark px-3 py-2 d-flex lead bg-white"
                href="/tags/modern-art"
              >
                <div className="flex-grow-1">
                  Modern Art<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              <a
                className="text-dark px-3 py-2 d-flex lead bg-white"
                href="/tags/motivation"
              >
                <div className="flex-grow-1">
                  Motivation<small className="ms-1">(2)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Nature<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Tech<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
