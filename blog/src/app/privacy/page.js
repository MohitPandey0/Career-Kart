    ...
    <div className="container">
      <div className="row gy-3 align-items-center section-title mb-0">
        <div className="col-sm-6">
          <h1 className="h3 mb-0 title">Privacy</h1>
        </div>
      ...
      <div className="row justify-content-center">
        <div className="col-xl-9 col-lg-10">
          <div className="content">
            <p>
              <em>Last updated on</em> — <strong>January 14, 2023</strong>
            </p>
            <p>
              Below are our dummy <a href="#!">Privacy &amp; Policy</a>, which
              outline a lot of legal goodies, but the bottom line is it’s our
              aim to always take care of both you, as a customer, or as a seller
              on our platform.
            </p>
            ...
            <h4 id="here-are-terms-of-our-standard-license">
            ...
            <h4 id="if-you-opt-for-an-extended-license">
