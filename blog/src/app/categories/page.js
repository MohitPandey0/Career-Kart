    ...
    <div className="container">
      <div className="row gy-3 align-items-center section-title mb-0">
        <div className="col-sm-6">
          <h1 className="h3 mb-0 title">Categories</h1>
        </div>
        ...
        <div className="col-xl-9 col-lg-10 mx-auto">
          ...
          <div className="row g-2 taxonomy-lists">
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Artwork<small className="ms-1">(1)</small>
                </div>
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Geography<small className="ms-1">(1)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Health<small className="ms-1">(2)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-4 col-6">
              ...
              >
                <div className="flex-grow-1">
                  Tech<small className="ms-1">(3)</small>
                </div>
                <div className="flex-shrink-0 ms-2 icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
