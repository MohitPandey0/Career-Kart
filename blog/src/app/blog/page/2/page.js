                                    ...
                                    <nav className="navbar navbar-expand-lg navbar-light p-0">
                                        ...
                                        <div className="collapse navbar-collapse" id="navHeader">
                                            ...
                                            <ul className="navbar-nav ms-auto animate">
                                                ...
                                                <li className="nav-item ">
                                                    <Link href="/letest" className="nav-link">
                                                        letest
                                                    </Link>
                                                </li>
                                                <li className="nav-item ">
                                    ...
                                    <div className="col-sm-6 text-sm-end">
                                        <nav aria-label="breadcrumb">
                                            <ul className="list-inline breadcrumb-menu breadcrumb-menu-truncate">
                                                ...
                                                <li className="list-inline-item">
                                                    <a className="text-link" href="/blog/page/2">
                                                        2
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <div className="row gy-5 gx-4 g-xl-5">
                                    <div className="col-lg-4 col-md-6">
                                        <article className="bg-white d-flex flex-column h-100">
                                            <div className="post-image">
                                                ...
                                                >
                                                    <img
                                                        alt="Why ‘facial expression recognition’ AI is a total scam"
                                                        srcSet="/_next/image?url=%2Fimages%2Fblog%2F03.jpg&w=384&q=75 1x, /_next/image?url=%2Fimages%2Fblog%2F03.jpg&w=750&q=75 2x"
                                                        src="/_next/image?url=%2Fimages%2Fblog%2F03.jpg&w=750&q=75"
                                                        width={368}
                                                        height={238}
                                                        decoding="async"
                                                        data-nimg={1}
                                            ...
                                            <div className="p-4 pb-0 ">
                                                ...
                                                <div className="position-relative">
                                                    ...
                                                    <p className="mb-0 line-clamp clamp-3">
                                                        A team of researchers at Jilin Engineering Normal University
                                                        in China recently published a paper indicating they’d built an
                                                        AI model capable of...
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-12 text-center pt-4 mt-5">
                                        <ul className="pagination justify-content-center">
                                            ...
                                            <li className="page-item page-count" title="Page 2 of 2">
