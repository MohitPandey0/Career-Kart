                  ...
                  "
                        >
                          ...
                          <ul className="dropdown-menu">
                            ...
                            <li>
                              <a className="dropdown-item " href="/minimal">
                                Home Minimal
                              </a>
                            </li>
                          </ul>
              ...
              <div className="container">
                <div className="row gy-3 align-items-center section-title mb-0">
                  <div className="col-sm-6">
                    <h1 className="h3 mb-0 title">Featured Posts</h1>
                  </div>
                      ...
                      <div className="post-image">
                        ...
                        >
                          <img
                            ...
                            srcSet="/_next/image?url=%2Fimages%2Fblog%2F09.jpg&w=384&q=75 1x, /_next/image?url=%2Fimages%2Fblog%2F09.jpg&w=750&q=75 2x"
                            src="/_next/image?url=%2Fimages%2Fblog%2F09.jpg&w=750&q=75"
                            width={368}
                            height={238}
                            decoding="async"
                            data-nimg={1}
                      ...
                      <div className="p-4 pb-0 ">
                        ...
                        <div className="position-relative">
                          ...
                          <p className="mb-0 line-clamp clamp-3">
                            ...
                            predictions about artificial general intelligence, they’ve
                            become quieter lately. Peter Thiel...
                          </p>
                        </div>
                      </div>
                      <div className="post-author d-flex mt-auto p-4">
