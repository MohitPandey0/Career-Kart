              ...
              <div className="container">
                <div className="row gy-3 align-items-center section-title mb-0">
                  <div className="col-sm-6">
                    <h1 className="h3 mb-0 title">About Us</h1>
                  </div>
              ...
              <div className="container">
                <div className="row justify-content-center">
                  <div className="col-xl-9 col-lg-10">
                    <img
                      alt="About Us"
                      srcSet="https://source.unsplash.com/random/876x398/?blog"
                      src="https://source.unsplash.com/random/876x398/?blog"
                      width={876}
                      height={398}
                      decoding="async"
                      data-nimg={1}
                      className="transition bg-light d-inline-block img-fluid h-auto mb-5"
                      loading="lazy"
                      style={{ color: "transparent" }}
                    />
                    <div className="content">
                      <h3 id="tushi-is-a-media-network-that-builds-and-operates">
                        Tushi is a media network that builds and operates.
                      </h3>
                      <p>
                        We do this with the aim of creating the future of media. The
                        future of media is one that is disruptive, agile, and credible. It
                        embraces diversity, creates a positive impact, and leaves its
                ...
                <div className="row justify-content-center">
                  <div className="col-xl-9 col-lg-10">
                    <div className="section-title">
                      <h2 className="h3 mb-0 title">Our Story</h2>
                    </div>
                      ...
                      <div className="col-md-6">
                        <div className="content">
                          <p>
                            ...
                            trustworthy and demonstrate integrity. We push ourselves to
                            move fast and not be afraid to change things up.
                          </p>
                          <p>
                  ...
                  <div className="col-xl-9 col-lg-10">
                    <div className="row align-items-center section-title">
                      <div className="col-sm-7">
                        <h2 className="h3 mb-0 title">Our Authors</h2>
                      </div>
                      ...
                      <div className="col-md-6">
                        ...
                        >
                          <div className="flex-shrink-0 me-3">
                            <img
                              alt="Ann Monika"
                              srcSet="/_next/image?url=%2Fimages%2Fauthor%2Fann-monika.jpg&w=96&q=75 1x, /_next/image?url=%2Fimages%2Fauthor%2Fann-monika.jpg&w=256&q=75 2x"
                          ...
                          <div className="flex-grow-1">
                            <div className="d-flex flex-column h-100">
                              ...
                              <p className="fw-medium mt-auto mb-0 small">
                                ...
                                <span className="text-black">03</span> Published posts
                              </p>
                            </div>
                          </div>
                        </a>
                      ...
                      <div className="col-md-6">
                        ...
                        >
                          <div className="flex-shrink-0 me-3">
                            <img
                              alt="Robert Britt"
                              srcSet="/_next/image?url=%2Fimages%2Fauthor%2Frobert-britt.jpg&w=96&q=75 1x, /_next/image?url=%2Fimages%2Fauthor%2Frobert-britt.jpg&w=256&q=75 2x"
                          ...
                          <div className="flex-grow-1">
                            <div className="d-flex flex-column h-100">
                              ...
                              <p className="fw-medium mt-auto mb-0 small">
                                ...
                                <span className="text-black">02</span> Published posts
                              </p>
                            </div>
                          </div>
                        </a>
                      ...
                      <div className="col-md-6">
                        ...
                        >
                          <div className="flex-shrink-0 me-3">
                            <img
                              alt="Alexander Hipp"
                              srcSet="/_next/image?url=%2Fimages%2Fauthor%2Falexander-hipp.jpg&w=96&q=75 1x, /_next/image?url=%2Fimages%2Fauthor%2Falexander-hipp.jpg&w=256&q=75 2x"
                      ...
                      <div className="col-md-6">
                        ...
                        >
                          <div className="flex-shrink-0 me-3">
                            <img
                              alt="Anil Vugels"
                              srcSet="/_next/image?url=%2Fimages%2Fauthor%2Fanil-vugels.jpg&w=96&q=75 1x, /_next/image?url=%2Fimages%2Fauthor%2Fanil-vugels.jpg&w=256&q=75 2x"
