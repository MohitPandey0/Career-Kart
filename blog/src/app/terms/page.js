    ...
    <div className="container">
      <div className="row gy-3 align-items-center section-title mb-0">
        <div className="col-sm-6">
          <h1 className="h3 mb-0 title">Terms of Service</h1>
        </div>
      ...
      <div className="row justify-content-center">
        <div className="col-xl-9 col-lg-10">
          <div className="content">
            <p>
              <em>Effective date</em> — <strong>January 22, 2023</strong>
            </p>
            <h3 id="a-definitions">A. Definitions</h3>
            <p>
              <strong>Short version:</strong> We use these basic terms
              throughout the agreement, and they have specific meanings. You
              should know what we mean when we use each of the terms. There's
              not going to be a test on it, but it's still useful information.
            </p>
            <ol>
              <li>
                <p>
                  An "Account" represents your legal relationship with Tushi. A
                  “Personal Account” represents an individual User’s
                  authorization to log in to and use the Service and serves as a
                  User’s identity on Tushi. “Organizations” are shared
                  ...
                  many projects at once. A Personal Account can be a member of
              ...
              <li>
                <p>
                  ...
                  conditions, notices contained or referenced in this document
                  (the “Terms of Service” or the "Terms") and all other
                  operating rules, policies (including the Tushi Privacy
                  Statement, available at <a href="/privacy">privacy</a>) and
                  procedures that we may publish from time to time on the
                  Website. Most of our site policies are available at{" "}
                  <a href="/privacy">privacy</a>.
                </p>
              </li>
              <li>
                <p>
                  "Beta Previews" mean software, services, or features
                  identified as alpha, beta, preview, early access, or
            ...
            <p>
              <strong>Short version:</strong> Personal Accounts and
              Organizations have different administrative controls; a human must
              create your Account; you must be 13 or over; you must provide a
              valid email address; and you may not have more than one free
              Account. You alone are responsible for your Account and anything
              that happens while you are signed in to or using your Account. You
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  an owner of an Organization. If you are the owner of an
