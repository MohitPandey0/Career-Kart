    ...
    <div className="container">
      <div className="row justify-content-center">
        <div className="col-xl-9 col-lg-10 text-center">
          <div className="mb-5">
            <img
              alt="I'm Alexander Hipp"
              srcSet="https://source.unsplash.com/random/180x180/?blog"
              src="https://source.unsplash.com/random/180x180/?blog"
              width={180}
              height={180}
              decoding="async"
              data-nimg={1}
          ...
          <p className="mb-2">Welcome to my personal Blog</p>
          <h1 className="h2 text-dark mb-4">I'm Alexander Hipp</h1>
          <div className="content">
            <p>
              A writer, musician, and content strategist with a passion for
              language. When she isn’t helping clients, you can find her writing
              songs, hiking in a northern forest, or furiously journaling.
            </p>
          </div>
          <ul className="list-inline social-links mt-4">
            <li className="list-inline-item me-4 mt-1 text-center">
              <a
      ...
      >
            ...
            <div className="p-4">
              <ul className="taxonomy-lists taxonomy-lists-active list-unstyled list-inline mb-3">
                <li className="list-inline-item me-1">
                  <a className="bg-white" href="/tags/motivation">
                    <span className="small me-1">#</span>Motivation
                  </a>
                </li>
                <li className="list-inline-item me-1">
                  <a className="bg-white" href="/tags/health">
                    <span className="small me-1">#</span>Health
                  </a>
                </li>
              </ul>
        ...
        <div className="col-xl-9 col-lg-10">
          <article className="bg-white d-flex flex-column">
            <div className="p-4">
              <ul className="taxonomy-lists taxonomy-lists-active list-unstyled list-inline mb-3">
                <li className="list-inline-item me-1">
                  <a className="bg-white" href="/tags/culture">
                    <span className="small me-1">#</span>Culture
                  </a>
                </li>
                <li className="list-inline-item me-1">
                  <a className="bg-white" href="/tags/lifestyle">
                    <span className="small me-1">#</span>Lifestyle
                  </a>
                </li>
              </ul>
              <div className="position-relative">
        ...
        <div className="col-xl-9 col-lg-10">
          <article className="bg-white d-flex flex-column">
            <div className="p-4">
              <ul className="taxonomy-lists taxonomy-lists-active list-unstyled list-inline mb-3">
                <li className="list-inline-item me-1">
                  <a className="bg-white" href="/tags/job">
                    <span className="small me-1">#</span>Job
                  </a>
                </li>
              </ul>
              <div className="position-relative">
        ...
        <div className="col-xl-9 col-lg-10">
          <article className="bg-white d-flex flex-column">
            <div className="p-4">
              <ul className="taxonomy-lists taxonomy-lists-active list-unstyled list-inline mb-3">
                <li className="list-inline-item me-1">
                  <a className="bg-white" href="/tags/earth">
                    <span className="small me-1">#</span>Earth
                  </a>
                </li>
                <li className="list-inline-item me-1">
                  <a className="bg-white" href="/tags/nature">
                    <span className="small me-1">#</span>Nature
                  </a>
                </li>
              </ul>
              <div className="position-relative">
                ...
                <p className="mb-0 line-clamp clamp-2">
                  ...
                  Amazon River has no bridges. None. Zero. Zilch. That is in
                  spite of the fact that the Amazon is 4,345 miles long.
                </p>
              </div>
              <ul className="post-meta list-inline mt-3">
                <li className="list-inline-item">
        ...
        <div className="col-xl-9 col-lg-10 text-center pt-5 mt-5">
          <ul className="pagination justify-content-center">
            ...
            <li className="page-item page-count" title="Page 1 of 3">
              <span className="current-page">1</span>
              <span className="total-page">3</span>
            </li>
