      ...
      <div className="row justify-content-center">
        <div className="col-xl-9 col-lg-10 text-center">
          <div className="mb-5">
            <img
              alt="Ann Monika"
              srcSet="/_next/image?url=%2Fimages%2Fauthor%2Fann-monika.jpg&w=256&q=75 1x, /_next/image?url=%2Fimages%2Fauthor%2Fann-monika.jpg&w=384&q=75 2x"
              src="/_next/image?url=%2Fimages%2Fauthor%2Fann-monika.jpg&w=384&q=75"
              width={180}
              height={180}
              decoding="async"
              data-nimg={1}
              className="transition bg-light d-inline-block img-fluid"
              loading="lazy"
              style={{ color: "transparent" }}
            />
          </div>
          <h1 className="h2 text-dark mb-1">Ann Monika</h1>
          ...
          <p className="mb-3">
            ...
            <span className="fw-medium text-black ms-1">03</span> Published
            posts
          </p>
          <div className="content">
            <p>
              Monika is a writer, musician, and content strategist with a
              passion for language. When she isn’t helping clients, you can find
              her writing songs, hiking in a northern forest, or furiously
              journaling.
            </p>
          </div>
          <ul className="list-inline social-links mt-4">
            <li className="list-inline-item me-3 mt-1 text-center">
              <a
              ...
              >
                ...
                <span className="text-link ms-2">Twitter</span>
              </a>
            </li>
            <li className="list-inline-item me-3 mt-1 text-center">
              <a
              ...
              >
                ...
                <span className="text-link ms-2">Linkedin</span>
              </a>
            </li>
            <li className="list-inline-item me-3 mt-1 text-center">
              <a
              ...
              >
                ...
                <span className="text-link ms-2">Facebook</span>
              </a>
            </li>
          </ul>
      ...
      <div className="row align-items-center section-title">
        <div className="col-12">
          <div className="section-title mb-3 text-center">
            ...
            <h2 className="h3 mb-0 title">Ann Monika</h2>
          </div>
        </div>
      </div>
        ...
        <div className="col-lg-4 col-md-6">
          <article className="bg-white d-flex flex-column h-100">
            <div className="post-image">
              ...
              >
                <img
                  alt="Yes, your company can trademark a color — here’s how"
                  srcSet="/_next/image?url=%2Fimages%2Fblog%2F01.jpg&w=384&q=75 1x, /_next/image?url=%2Fimages%2Fblog%2F01.jpg&w=750&q=75 2x"
                  src="/_next/image?url=%2Fimages%2Fblog%2F01.jpg&w=750&q=75"
                  width={368}
                  height={238}
                  decoding="async"
                  data-nimg={1}
            ...
            <div className="p-4  ">
              ...
              <div className="position-relative">
                ...
                <p className="mb-0 line-clamp clamp-3">
                  According to research up to 90% of consumers’ snap judgments
                  made about products can be based on color alone. Color also
