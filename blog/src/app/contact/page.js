                  ...
                  <div className="col-xl-9 col-lg-10">
                    ...
                    <div className="row gy-5 gx-lg-5">
                      <div className="col-lg-6 order-1 order-lg-0">
                        <form className="row gy-4" method="POST">
                          <div className="col-md-12">
                            <input
                              type="hidden"
                              name="_subject"
                              defaultValue="Message form Tushi Next.js!"
                            />
                            <input
                              type="email"
                      ...
                      <div className="col-lg-6 order-0 order-lg-1">
                        <div className="ps-0 ps-lg-4">
                          <div className="mb-4 mb-lg-5">
                            ...
                            <p>
                              We'll answer every question you might have. Look forward to
                              hearing from you
                            </p>
                          </div>
                          <p className="mb-3">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="d-inline-block me-3 text-dark"
                              width={20}
                              height={20}
                              viewBox="0 0 24 24"
                              strokeWidth={2}
                            ...
                            <a className="text-link" href="mailto:hellotushi@gmail.com">
                              hellotushi@gmail.com
                            </a>
                          </p>
                          <p className="mb-0">
                            <svg
                            ...
                            <a className="text-link active" href="tel:+98022964902">
                              +98 02 296 4902
                            </a>
                          </p>
                        </div>
